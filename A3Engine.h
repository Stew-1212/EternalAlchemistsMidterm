...
private:
    ...
    /// \desc the arc ball cam camera in our world
    CSCI441::Camera* _pMainCam;
    CSCI441::Camera* _pSecondaryCam;
    ...
    /// \desc Caedilas model
    Caedilas* _pCaedilas;
    /// \desc Caedilas's move and turn speed
    glm::vec2 _playerSpeed;
